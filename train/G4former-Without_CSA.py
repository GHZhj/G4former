...
def train_val(model, train_loader, val_loader, criterion, device, optimizer, scheduler,
    ...
    for epoch in range(epochs):
        ...
        epoch_model_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_A-epoch_1_64_{lr}_{name}.pth'
    ...
    if best_model_wts is not None:
        model_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_A-{batch_size}_{lr}_{name}.pth'
    ...
    if best_val_targets is not None:
        ...
        csv_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_A-{batch_size}_{lr}_{name}_best_preds.csv'
...
class G4former(nn.Module):
    ...
    def forward(self,input_ids,species_ids, w ):
        ...
        outputs = self.adaptive_norm(x, conditions=conditions)
...
def main():
    ...
    if True:
        ...
        model = G4former().to(device)
        best_model_wts = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_A-epoch_1_64_{lr}_{name}.pth'
        if best_model_wts:
