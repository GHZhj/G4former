...
class GenomicDataset(Dataset):
    ...
    Dnase_Z_F, Dnase_Z_Z, Dnase_F_F, Dnase_F_Z , name
...
def main():
    for Tsetmodel in name_list: 
        model = G4former().to(device)
        if True:
            if Tsetmodel != "293T":
                best_model_wts = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_epoch_1_64_3e-05_{Tsetmodel}.pth'
            else:
                best_model_wts = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_293T_epoch_1_64_3e-05_293T.pth'
            if True:
        ...
        for name in name_list:
            ...
            if True:
                ...
                csv_path = f'/home/hjzhang/dataset/home-1/ylxiong/caduceus/_auc/_{Tsetmodel}-{name}_best_preds.csv'
                ...
                print( f" {Tsetmodel} - {name} Test Acc={val_accs[-1]:.4f}, ", f"Loss ={val_losses[-1]:.4f}, ",
