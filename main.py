...
def train_val(model, train_loader, val_loader, criterion, device, optimizer, scheduler,
    ...
    for epoch in range(epochs):
        ...
        if name == "293T":
            epoch_model_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_293T_epoch_1_64_{lr}_{name}.pth'
        else:
            epoch_model_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_epoch_1_64_{lr}_{name}.pth'
    ...
    if best_model_wts is not None:
        if name == "293T":
            model_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_293T_{batch_size}_{lr}_{name}.pth'
        else:
            model_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_{batch_size}_{lr}_{name}.pth'
    ...
    if best_val_targets is not None:
        ...
        csv_path = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_{batch_size}_{lr}_{name}_best_preds.csv'
...
def main():
    ...
    if True:
        ...
        model = G4former().to(device)
        if name == "293T":
            best_model_wts = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_293T_epoch_1_64_{lr}_{name}.pth'
        else:
            best_model_wts = f'/home/hjzhang/dataset/home-1/ylxiong/Center/1k/ck/results/save_L1k_-11-58_epoch_1_64_{lr}_{name}.pth'
        if best_model_wts:
